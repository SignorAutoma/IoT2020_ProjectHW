...
import MQTTbridgeGoogle
import ssl

project_id = 'signorautoma-iot'
cloud_region = 'europe-west1'
registry_id = 'first-assignment'
device_id = 'devices'
...
client = MQTTbridgeGoogle.get_client(
...
if __name__ == "__main__":
    ...
    rc, topic1 = aclient.subscribe("devices")
    while(1):{}